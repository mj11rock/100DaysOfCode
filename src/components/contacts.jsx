      ...
      <div className="contacts center">
        ...
        <div className="social-nets">
          <ul>
            <li className="icon">
              <a
                href="https://github.com/mj11rock"
                target="_blank"
            ...
            <li className="icon">
              <a
                href="https://www.instagram.com/is_100dys/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <li className="icon">
              ...
              >
                <svg
                  ...
                  class="svg-inline--fa fa-facebook-f fa-w-14"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 320 512"
                >
